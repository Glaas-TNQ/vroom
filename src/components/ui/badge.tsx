  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        accent: "border-transparent bg-accent text-accent-foreground shadow-sm hover:bg-accent/90 hover:shadow-md",
        ...
        outline: "border-primary/30 text-foreground hover:bg-primary/5 hover:border-primary/50",
        gradient: "border-transparent gradient-bg-primary text-primary-foreground shadow-sm hover:shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
